...
class MFGSourceSpec extends FlatSpec with Matchers with ScalaFutures {
  import SourceExt._
  ...
  "MFGSource bulkAsyncPuller" should "end the stream when nothing to pull" in {
    whenReady(
  ...
  "MFGSource unfoldPullerAsync" should "perform a async unfold" in {
  ...
  "MFGSource from File" should "read a local file" in {
  ...
  "MFGSource seededLazyAsync" should "create a stream from a future lazily evaluated" in {
  ...
  "MFGSource singleLazyAsync" should "create a stream from a future lazily evaluated" in {
    def futTs() = Future.successful(System.nanoTime())
  ...
  "MFGSource singleLazy" should "create a stream from a future lazily evaluated" in {
  ...
  "MFGSource constantLazyAsync" should "create a repeated stream from a future lazily evaluated" in {
  ...
  "MFGSource constantLazy" should "create a repeated stream from a future lazily evaluated" in {
